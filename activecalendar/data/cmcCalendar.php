...
$yearID=date("Y"); // GET variable for the year, init 2005 to display the year of the event file
$monthID=date("m"); // GET variable for the month, init 10 to display the month of the event file
...
********************************************************************************
*/
$filePath="xmlevents.txt"; // the path of the events xml file
