...
?>
					<FORM name="form1" action="login.php?pg=Monitory" method="post">
					<TABLE cellPadding=4 width="100%">
					  <TBODY>
					  <TR>
						<TD class=zLoginLabelContainer><LABEL for=username>Username:</LABEL></TD>
					  ...
					  <TR>
						...
						<TD><INPUT class="zLoginButton" type="submit" value="Log In" name="MonitorLogin"></TD>
					</TR>
					</TBODY>
					</TABLE>
					</FORM>
...
?>
				...
				<div align="center">
					...
					<p>contact <a href="mailto(info@nexzoninvestment.com)">system administrator</a> for details </p>
			   </div>
<?PHP
		}elseif ($Page == "Admin") {
...
?> 	
						<FORM name="form1" action="login.php?pg=Teacher" method="post">
						<TABLE cellPadding=4 width="100%">
						  <TBODY>
						  <TR>
							<TD width="80" class=zLoginLabelContainer><LABEL for=username>Username:</LABEL></TD>
							<TD class=zLoginFieldContainer colSpan=2><INPUT 
							  class="zLoginField" id="UserName" name="UserName"> </TD></TR>
						  <TR>
							<TD class=zLoginLabelContainer><LABEL 
						  ...
						  <TR>
							...
							<TD width="949"><INPUT class="zLoginButton" type="submit" value="Log In" name="TeacherLogin"></TD>
						</TR>
						</TBODY>
						</TABLE>
						</FORM>	
