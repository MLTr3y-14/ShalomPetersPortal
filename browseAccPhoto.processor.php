...
$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'admission.php?subpg=Other Details&regNo='.$RegNo; 

// fieldname used within the file <input> of the HTML form 
$fieldname = 'file';

// make a note of the location of the success page 
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'admission.php?subpg=Other Details&regNo='.$RegNo.'&afilename=' ; 
