...
$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'uploadstudentphoto.php?subpg=upload picture'; 
// make a note of the location of the success page 
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'uploadstudentphoto.php?subpg=upload picture';
