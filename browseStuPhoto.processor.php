...
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'admission.php?subpg=Admission'; 
...
if(!get_magic_quotes_gpc())
{
	...
	<?PHP $query = "update tbstudenttemppic set PicName = '$FullFileName', Content = '$image', Status = '1'";
