<?PHP
	...
	{
		$ReceiptNo = $_GET['rid'];
		$query3 = "select * from tbreceipt where ID='$ReceiptNo' where Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
...
<?PHP
$query2 = "select Stu_Regist_No,Stu_Sec,AdmissionNo,Stu_Type,Stu_Class from tbstudentmaster where Stu_Full_Name = '$studentname' "; 
                       //and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'
					   // echo $Term_ID ;                
                                 $counter = 0;
								$result2 = mysql_query($query2,$conn);
								$num_rows2 = mysql_num_rows($result2);
...
<?PHP
					$query2 = "select * from tbreceipt where Status ='2' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
					$result2 = mysql_query($query2,$conn);
					$num_rows2 = mysql_num_rows($result2);
					if ($num_rows2 > 0 ) {
						while ($row2 = mysql_fetch_array($result2)) 
