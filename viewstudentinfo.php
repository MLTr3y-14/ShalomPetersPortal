...
?>
		  ...
		  function displaydata(data,ioArgs){
			  ...
			  var class1 = data.studentclass;
			   //var class = 'Primary 1A';
			...
			//test.innerHTML = test2;
				//alert('testing123' + name );
				document.getElementById('divLoading').style.display = 'none';
		      }
		function helloError(data, ioArgs) {
        alert('Please Select Student Name/Error when retrieving data from the server!');
		//var listBox = document.getElementById('Names');
     }
</script>
                <TABLE height="300" >
