...
session_start();
  ...
  $teacherid = $_GET['name2'];
  $query = "Delete From tbclassteachersubj where ID = '$teacherid'";
   $result = mysql_query($query,$conn);
   
$query = "select ClassId, SubjectId, ID from tbclassteachersubj where EmpId IN (select ID from tbemployeemasters where EmpName = '$teachername')";
						$result = mysql_query($query,$conn);
