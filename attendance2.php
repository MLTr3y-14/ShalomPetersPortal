<?PHP
	...
	{	
		...
		$i=0;
		$query3 = "select ID from tbsubjectmaster where ID IN(Select SubjectId from tbclasssubjectrelation where ClassId = '$OptClassEdit' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID') and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
		...
		$i=1;
		$query3 = "select LecNo,SubjID from tbclasstimetable where ClassID = '$ClassID' And Term = '$Activeterm' and WeekDay = 'Wednesday' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
		$result3 = mysql_query($query3,$conn);
		$num_rows = mysql_num_rows($result3);
		if ($num_rows > 0 ) {
			while ($row = mysql_fetch_array($result3)) 
		...
		$i=1;
		$query3 = "select LecNo,SubjID from tbclasstimetable where ClassID = '$ClassID' And Term = '$Activeterm' and WeekDay = 'Thurday' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
		$result3 = mysql_query($query3,$conn);
		$num_rows = mysql_num_rows($result3);
		if ($num_rows > 0 ) {
			while ($row = mysql_fetch_array($result3)) 
		...
		$i=1;
		$query3 = "select LecNo,SubjID from tbclasstimetable where ClassID = '$ClassID' And Term = '$Activeterm' and WeekDay = 'Friday' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
		$result3 = mysql_query($query3,$conn);
		$num_rows = mysql_num_rows($result3);
		if ($num_rows > 0 ) {
			while ($row = mysql_fetch_array($result3)) 
		...
		$i=1;
		$query3 = "select LecNo,SubjID from tbclasstimetable where ClassID = '$ClassID' And Term = '$Activeterm' and WeekDay = 'Saturday' and Session_ID = '$Session_ID' and Term_ID = '$Term_ID'";
		$result3 = mysql_query($query3,$conn);
		$num_rows = mysql_num_rows($result3);
		if ($num_rows > 0 ) {
			while ($row = mysql_fetch_array($result3)) 
...
$stmt = $pdo->prepare("SELECT * FROM tbdepartments where Session_ID = '$Session_ID' and Term_ID = '$Term_ID'");
// do something
$stmt->execute();
...
?>
			...
			function getattendanceinfo(data,ioArgs){
				...
				var subjectlistBox = document.getElementById('classinfo');
						...
						subjectlistBox.innerHTML = topinfo + ' ' + class +' ' + lectureday + '----' + 'Lecture No:' + ' ' + lectureNo ;
