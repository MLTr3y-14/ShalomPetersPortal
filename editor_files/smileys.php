...
function insert() {
	if (smiley != null) {
		...
		var width = images[0].getAttribute("width").toString();
		var height = images[0].getAttribute("height").toString();
		
		parentWindow.wp_create_image_html(obj,imagePath, width, height, '', '', '', '');
	}
	window.close();
	return false;
}
