...
$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'mas_setup.php?subpg=School%20Name%20and%20Logo%20Setup'; 
// make a note of the location of the success page 
$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'mas_setup.php?subpg=School%20Name%20and%20Logo%20Setup' ;
...
if(!get_magic_quotes_gpc())
{
	...
	$query = "update tbschool set HeaderPic = '$FullFileName' where ID = '3'";
