 ...
 *                              -------------------
 *  author      : Chris Bolt
 *  copyright   : (C) Chris Bolt 2007. All Rights Reserved
 *  version     : 2.2.13.2
...
/*
***************************************************************************************************
* NOTE to Application Developers: We have no way to know or understand your file or user security *
* scheme. If you are adding WysiwygPro into your application, then YOU must also add appropriate  *
* code to this file to ensure that any direct access to the WysiwygPro document and image         *
* managers (image.php & document.php) is as secure as intended.                                   *
***************************************************************************************************
*/
...
define('WP_WEB_DIRECTORY', 'skoolnet/editor_files/');
...
define('IMAGE_WEB_DIRECTORY', 'skoolnet/Images/');
...
define('DOCUMENT_FILE_DIRECTORY', '../');
...
define('SMILEY_FILE_DIRECTORY', 'images/smileys/');


// SMILEY_WEB_DIRECTORY
// The web address of the directory you specified above

define('SMILEY_WEB_DIRECTORY', 'images/smileys/');
...
$max_image_width = 1000;                         // maximum allowed width of uploaded images in pixels
$max_image_height = 1000;                        // maximum allowed height of uploaded images in pixels
$max_file_size = 1000000;                         // maximum allowed filesize for uploaded images upload in bytes
...
define('SAVE_LENGTH', 900);                             // length of time to cache configurations for
define('NOCACHE', true);                                 // whether to send nocache headers to prevent proxy servers from sending the wrong content to browsers

// NOTE: chmod settings should always start with a 0, e.g. use 0777 instead of 777
// Set to 0 for no chmod
