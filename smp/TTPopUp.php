<?PHP
	...
	if(isset($_GET['EmpId']))
	{
		...
		$SubjID = $_GET['subj'];
		//GET Subject Teacher
		$query2 = "select ClassID from tbclassteachersubj where EmpId = '$EmpId' And SecID = '$Activeterm' And SubjectID = '$SubjID'";
		$result2 = mysql_query($query2,$conn);
		$dbarray2 = mysql_fetch_array($result2);
...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>iSchool Manager:: School Management System</TITLE>
    ...
    <TD height="300" align=middle style="BACKGROUND-COLOR: transparent" valign="top">
	  ...
	  <TR>
		...
		<TABLE style="FONT-SIZE: 10pt; FONT-FAMILY: Verdana; HEIGHT: 125px" cellPadding=0 border=0>
			...
			<TR>
			  <TD width="137" align=right><LABEL for=Login1_UserName>Class Name :</LABEL></TD>
			  <TD width="322"><?PHP echo GetClassName($ClassID); ?></TD>
			</TR>
			<TR>
